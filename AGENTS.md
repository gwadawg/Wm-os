...
| **RM client video ads — brainstorm + compliant scripts** | [.claude/skills/rm-creative-studio/SKILL.md](.claude/skills/rm-creative-studio/SKILL.md) → render in wm-creative |
| **DSCR client video ads — brainstorm + compliant scripts** | [.claude/skills/dscr-creative-studio/SKILL.md](.claude/skills/dscr-creative-studio/SKILL.md) — [rulebook](docs/client-fulfillment/dscr-dna/dscr-video-script-playbook.md) → render in wm-creative |
...
| **Instagram carousels (all lanes) — copy here, render in wm-creative** | [SOP](docs/content-engine/carousel-production.md) → sibling repo `wm-creative/.claude/skills/wm-carousel-studio/SKILL.md` |
...
| **Meta campaign / ad set structure + creative testing** | [creative-testing-structure.md](docs/client-fulfillment/media-buying/creative-testing-structure.md) — **draft proposal** (Scale CBO + Test ABO, roster waves; not active until reviewed) — [scorecard](docs/client-fulfillment/media-buying/creative-testing-scorecard.md) — [awareness ladder](docs/client-fulfillment/media-buying/creative-awareness-ladder.md) — [wave log](docs/client-fulfillment/media-buying/performance-learnings.md) |
| **Owned ad winners (Mr. Waiz → OS)** | [docs/operations/ad-intelligence-bridge.md](docs/operations/ad-intelligence-bridge.md) — [RM ad development workflow](docs/client-fulfillment/media-buying/ad-development-workflow.md) — [ad naming](docs/client-fulfillment/media-buying/ad-naming-convention.md) — **label skill** [.cursor/skills/ad-naming/SKILL.md](.cursor/skills/ad-naming/SKILL.md) (queries Mr. Waiz, not OS) — [DSCR static ad creation](docs/client-fulfillment/dscr-dna/dscr-static-image-generator-project.md) — [manifest](docs/client-fulfillment/media-buying/ad-creative-manifest.yaml) |
...
**Content engine entry:** [docs/content-engine/README.md](docs/content-engine/README.md) — [infrastructure](docs/content-engine/INFRASTRUCTURE.md), [lane boundaries](docs/content-engine/LANE-BOUNDARIES.md), [carousel SOP](docs/content-engine/carousel-production.md), [ClickUp personal pipeline](docs/content-engine/clickup-personal-brand-pipeline.md), archive policy.
...
**Ad intelligence:** Mr. Waiz `ad_library` is what the agent reads for owned creatives (`summary`, tags, type, KPIs). Drive is the human file vault — do not fetch it. If a row’s `summary` is empty or vague, **ask before generating** — do not invent. Wm-os stores distilled swipes and catalogs only. **Production loop:** [creative-production-loop.md](docs/client-fulfillment/media-buying/creative-production-loop.md). Bridge: [ad-intelligence-bridge.md](docs/operations/ad-intelligence-bridge.md). Create **RM** ads via [ad-development-workflow.md](docs/client-fulfillment/media-buying/ad-development-workflow.md). Create **DSCR statics** via [dscr-static-image-generator-project.md](docs/client-fulfillment/dscr-dna/dscr-static-image-generator-project.md) (Ideogram → Mr. Waiz registration → Meta). **DSCR creative context:** load [intelligence-icp-dscr.md](docs/client-fulfillment/dscr-dna/intelligence-icp-dscr.md) + [dscr-creative-taxonomy.md](docs/client-fulfillment/dscr-dna/dscr-creative-taxonomy.md) (buckets / angles / naming — draft).
...
- Load [new-hire-mortgage-icp-primer.md](docs/company/new-hire-mortgage-icp-primer.md) for ads, scripts, funnels, nurture, bot copy, or ICP prompting — team training only; use product DNA instead
