...
| **Instagram carousels (all lanes) — HTML type cards → PNG** | [.claude/skills/instagram-carousel/SKILL.md](.claude/skills/instagram-carousel/SKILL.md) — [SOP](docs/content-engine/carousel-production.md) |
