---
title: LinkedIn LO Outreach — Copy And Angles
domain: acquisition
owner: setter
status: draft
...
# LinkedIn LO Outreach — Copy And Angles
...
**Signal:** Same reverse mortgage or retirement-lending group; or several mutual connections.
...
**Signal:** Recent post about a funded loan, production month, team win, or marketing test.
...
**Avoid:** Generic “loved your content.” Pull a **specific** line from the post.

---

## Angle 3 — Industry climate / volume

**Signal:** Post or comment about rates, slow referrals, lead quality, or “tough market.”
...
**Signal:** They liked or commented on a large reverse company, educator, or competitor page (you mined the engagement list).
...
**Signal:** New title, new company, “excited to announce” post.
...
**Track B:** If forward LO, use Angle 7 instead if reverse is not on their profile.

---

## Angle 7 — Recruit (forward LO)

**Signal:** Forward mortgage LO, minimal reverse content; Track B only.
...
**Gabriel note:** No hard recruit pitch in message 1. Explore fit before opportunity talk.

---

## Angle 8 — Outsourced LinkedIn

**Signal:** Post mentions VA, agency ran LinkedIn, or “taking my profile back.”
...
**Signal:** Senior producer, terse profile, C-suite or branch lead tone — unlikely to want small talk.
...
**Gabriel:** Skip long rapport; lead with insight after permission. See example thread B below.

---

## Angle 10 — Pattern interrupt

**Signal:** Only when profile shows personality (humor posts, casual comment style). **Do not force.**
...
**If no reply:** Do not double down on jokes; switch to value bump via Gabriel or archive.

---

## Example Threads (adapted structure — reverse LO)
...
- [Draft prompt](../../../../.claude/skills/linkedin-lo-outreach/prompt.md)
