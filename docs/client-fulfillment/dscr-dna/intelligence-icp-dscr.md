...
> Expanded production copy (human expand only):
> [dscr-campaign-master-angles.md](dscr-campaign-master-angles.md)
...
## 3. Product — only what sells

**One line:** DSCR refinance qualifies on **rent vs payment**, not personal
income. No W-2s / tax returns for qualification. Refinance only.
Business-purpose investment property.

**Big idea:** *"The property qualifies itself."*

| Selling point | Use it to say… |
|---------------|----------------|
| No income docs | Write-offs stop blocking the refi |
| Qualify on rent | Different basis of approval than the bank |
| Cash-out / velocity | Unlock equity without selling a door |
| Escape hard-money | Real urgency + clean long-term exit |
| LLC vesting | Structure like an operator |
| No conventional property-count ceiling | Portfolio isn't capped the same way |

**Honest trade:** rates often higher than conventional — win on access,
freed equity, and process. Never invent rates/LTV/day-counts in cold ads.
...
**Reframe:** sitting equity is dead capital. Scalers don't wait for new cash —
they pull capital from what they already own and redeploy it.

**Don't pitch a loan. Reveal how sophisticated investors already operate.**

| Mode | Viewer feels | Job |
|------|--------------|-----|
| Ego stroke | "That's already me." | Confirm strategy; invite next move |
| Aspiration | "I want to operate like that." | Model the habit; show the path |

**Lines:**

- "Real investors don't wait for capital. They take it from what they already own."
- "If you already have a portfolio, you've done the hardest part."
- "Your equity isn't a trophy. It's inventory."
- "You don't have to sell a door to fund the next one."

**Pattern:** identity call-out → break idle-equity belief → model the move →
name DSCR lightly → CTA ("see what your doors may unlock") — not "apply for a loan."

---

## 5. Proven starting angles (not a cage)
...
|--------------------|-------|------------------|---------|
| No appraisal | `[NO_APPRAISAL]` | Yes — **qualifying products only** | "No appraisal on qualifying products" — never imply every loan |
| Loan range | `[MIN_LOAN]`–`[MAX_LOAN]` | $75K–$5M | "Financing from … to …" |
| Credit floor | `[FICO_FLOOR]` | 660+ | "FICO [FICO_FLOOR]+" / "as low as …" |
...
## 8. NEVER list (compliance distilled)

- Purchase / "buy a rental" / acquisition framing
- Primary residence / personal / household use
- **Invented** rates, LTV, loan ranges, FICO, appraisal claims, day-counts, returns
...
Confirmed filter tokens (only if CONFIRMED):
  NO_APPRAISAL: [yes on qualifying products only | omit]
  LOAN_RANGE: [e.g. $75K–$5M]
  FICO_FLOOR: [e.g. 660+]
  APR: [client-approved only | omit]
...
## Ops pointers (do not load for creative AI)
