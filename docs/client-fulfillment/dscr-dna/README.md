...
Deleted as noise (folded or superseded): doctrines, angle library, ads
playbook, MB copy standards, funnel-stage messaging, ad creative batch 01,
competitor ad intelligence essay (insights live in GTM; raw scrape in
`_research/`).

## Quick load (non-creative)
