---
title: Operations — Hiring (Media Buyer)
domain: operations
...
# Operations — Hiring (Media Buyer)

Media buyer hiring, onboarding, assessment, scorecard, and bootcamp.

## Canonical Docs (`draft` until reviewed)

- [Media Buyer Initial Onboarding Steps](mb-initial-onboarding-steps.md)
- [Media Buyer Onboarding Call SOP](media-buyer-onboarding-call-sop.md)
