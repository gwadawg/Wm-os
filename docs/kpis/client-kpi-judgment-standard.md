...
| **Show Rate** | Above > 70% · At 60–70% · Below 52–60% · 911 < 52% | At 56–70% · 911 < 51% | At-floor raised 56→60%. At 56% with At-KPI booking, CY falls below 0.167 and CPConv breaks $150 — so 56% was mislabeled "At". |
...
| R6 | CPQL At + Booked/QL At + **Show Below** | **Show Rate** (L4) | GHL reminder sequence + disposition logging + near-term slots. |
